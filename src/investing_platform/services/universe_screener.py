    ...
    def get_latest_snapshot(self) -> UniverseSnapshotResponse:
        ...
        rows = [
            UniverseCandidate(
                ...
                priceReturn20d=_optional_float(row.get("price_return_20d")),
                priceReturn60d=_optional_float(row.get("price_return_60d")),
                ...
                themeCluster=_optional_str(row.get("theme_cluster")),
                marketCap=_optional_float(row.get("market_cap")),
                tradabilityBalance=_optional_float(row.get("tradability_balance")),
